-- 2026-03-13 : Initialisation des donnees de test pour sprint5 (staging)
...
('2026-03-20 04:20:00', 'CLI-S5-001', 7, (SELECT Id_Hotel FROM staging.Hotel WHERE code = 'CLB')),
('2026-03-20 04:45:00', 'CLI-S5-002', 4, (SELECT Id_Hotel FROM staging.Hotel WHERE code = 'NOV')),
('2026-03-20 04:45:00', 'CLI-S5-003', 2, (SELECT Id_Hotel FROM staging.Hotel WHERE code = 'HBS')),
('2026-03-20 04:47:00', 'CLI-S5-004', 1, (SELECT Id_Hotel FROM staging.Hotel WHERE code = 'PAN'));
