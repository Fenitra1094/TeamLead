    ...
    public AssignationResult assignerPourDate(LocalDate date) throws SQLException {
        ...
        try {
            ...
            for (GroupeVol groupe : groupes) {
                LocalDateTime dateDepart = groupe.getHeureArrivee();
                ...
                while (!restantes.isEmpty()) {
                    ...
                    Trajet trajet = new Trajet(vehiculeChoisi.getIdVehicule(),
                            dateDepart,
